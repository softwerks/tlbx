...
cl /O2 /LD /MD /DSQLITE_API=__declspec(dllexport) /Fobuild\ /nologo lib\sqlite3\sqlite3.c /link /out:bin\sqlite3.dll /implib:build\sqlite3.lib
rem Lua
...
cl /O2 /LD /MD /DLUA_BUILD_AS_DLL /Fo..\..\..\build\ /nologo %lua_files% /link /out:..\..\..\bin\lua53.dll /implib:..\..\..\build\lua53.lib
echo Building lua interpreter...
cl /O2 /MD /Fo..\..\..\build\ /nologo lua.c /link ..\..\..\build\lua53.lib /out:..\..\..\bin\lua.exe
